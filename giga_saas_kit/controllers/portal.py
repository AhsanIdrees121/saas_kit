...
from giga.addons.portal.controllers.mail import _message_post_helper
from giga.addons.portal.controllers.portal import CustomerPortal, pager as portal_pager, get_records_pager
import logging
...
class CustomerPortal(CustomerPortal):
    ...
    def portal_my_contracts(self, page=1, date_begin=None, date_end=None, sortby=None, **kw):
        ...
        return request.render("giga_saas_kit.portal_my_saas_contracts", values)
    ...
    def portal_contract_page(self, contract=None, access_token=None, **kw):
        ...
        return request.render("giga_saas_kit.portal_contract_page", values)
