...
SERVER_TYPE = [
    ...
    # ('same_giga_server', "Current giga Server"),
    # ('different_giga_server', "Same machine with different giga server"),
    # ('different_giga_server', "Different giga Server"),
]
DB_SCHEME = [
...
class SaasServer(models.Model):
    ...
    giga_url = fields.Char(string="giga URL")
