...
def isdbaccessible(host_server,db_server):
    ...
    try:
        ...
        sftp.put("/opt/giga12/webkul_addons/giga_saas_kit/models/lib/connect_db.py",'/tmp/connect_db.py')
        sftp.close()
...
'''
isdbaccessible(host_server =  {'user': 'giga12', 'host':
    '192.168.10.214', 'server_type': 'remote', 'password': 'giga12', 'port':
    '22'},db_server = {'user': 'giga', 'host':
        '192.168.1.96', 'server_type': 'remote', 'password': 'giga',
        'port': '5432'})
'''
