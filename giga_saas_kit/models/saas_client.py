    ...
    def unlink(self):
        ...
        for obj in self:
            if obj.state == "stopped":
                ...
                response = client.main(domain=obj.database_name,container_id=obj.container_id,port=obj.containter_port,host_server=host_server,db_server=db_server, config_path = get_module_resource('giga_saas_kit'))
