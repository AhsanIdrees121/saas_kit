    ...
    def action_create_contract(self):
        for obj in self:
            ...
            try:
                ...
                action = self.env['ir.actions.act_window']._for_xml_id("giga_saas_kit.saas_contract_action")
                # action = self._xmlid_to_obj(self.env, 'giga_saas_kit.saas_contract_action')
                list_view_id = imd._xmlid_to_res_id('giga_saas_kit.saas_contract_tree_view')
                form_view_id = imd._xmlid_to_res_id('giga_saas_kit.saas_contract_form_view')
